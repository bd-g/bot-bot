...
<img src="https://www.zilch.dev/get-started-thumbnail.png" width="500px"/>
</a>
...
### <img align="right" src="./avatar.svg"/> This is Bot Bot, a [Table Tennis](https://www.zilch.dev/table-tennis) playing [Zilch](https://www.zilch.dev) bot.

[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/bd-g/bot-bot?quickstart=1)

<br/>

### Step &nbsp;1️⃣

> 👉 &nbsp;_Open **Chilly Camel** in a code editor._
...
> 👉 &nbsp;_Connect **Chilly Camel** to Zilch with the `./connect` (or on Windows `.connect.cmd`) command._

[Open a terminal](https://code.visualstudio.com/docs/terminal/basics), `cd` to the bot directory if needed, run `./connect` and follow the in-terminal instructions. This will establish a connection between Zilch and Chilly Camel. If you encounter any issues see the [detailed setup instructions](#detailed-setup-instructions) below.

<br/>

### Step &nbsp;3️⃣

> 👉 &nbsp;_Play a game with **Chilly Camel**._
